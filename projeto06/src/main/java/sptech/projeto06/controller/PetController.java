package sptech.projeto06.controller;

import jakarta.validation.Valid;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import org.springframework.web.server.ResponseStatusException;
import sptech.projeto06.exception.PetProtegidoException;
import sptech.projeto06.exception.QuantidadeMinimaPetsException;
import sptech.projeto06.model.Pet;
import sptech.projeto06.repository.PetRepository;
import sptech.projeto06.repository.RegrasRepository;
...
// podendo ser parcial e case INSENSITIVE
    ...
    public ResponseEntity<Pet> postPet(@RequestBody @Valid Pet pet) {
        // regra de exemplo: a api só pode ter 100 pets
 ...
 */
    ...
    public ResponseEntity<Void> deletePetPorId(@PathVariable Integer id) {
        // regra de exemplo: a api deve ter pelo menos 1 pet
