...
import sptech.projeto11.service.PetService;
...
public class PetController {
    ...
    public ResponseEntity<byte[]> getFotoPorId(@PathVariable Integer id) {
        return ResponseEntity.status(200).body(service.obterFoto(id));
    }
}
